...
public class MarioGame {
	...
	/**
	 * extra time before reporting that the agent is taking more time that it
	 * should
	 */
	...
	/**
	 * events that kills the player when it happens only care about type and
	 * param
	 */
	 ...
	 * 
	 * @param killPlayer
	 *            events that will kill the player
	 */
	 ...
	 * 
	 * @param level
	 *            a string that constitutes the mario level, it uses the same
	 *            representation as the VGLC but with more details. for more
	 *            details about each symbol check the json file in the levels
	 *            folder.
	 * @param timer
	 *            number of ticks for that level to be played. Setting timer to
	 ...
	 *            anything <=0 will make the time infinite
	 * @param marioState
	 *            the initial state that mario appears in. 0 small mario, 1
	 ...
	 *            large mario, and 2 fire mario.
	 * @param fps
	 *            the number of frames per second that the update function is
	 *            following
	 * @return statistics about the current game
	 */
	 ...
	 *            following
	 * @param scale
	 *            the screen scale, that scale value is multiplied by the actual
	 *            width and height
	 * @return statistics about the current game
	 */
	 ...
	 * 
	 * @param agent
	 *            the current AI agent used to play the game
	 * @param level
	 *            a string that constitutes the mario level, it uses the same
	 *            representation as the VGLC but with more details. for more
	 *            details about each symbol check the json file in the levels
	 ...
	 *            large mario, and 2 fire mario.
	 * @param visuals
	 *            show the game visuals if it is true and false otherwise
	 * @return statistics about the current game
	 */
