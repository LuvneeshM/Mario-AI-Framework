...
public class RunnerFrame extends JFrame implements KeyListener {
	...
	public RunnerFrame(String[] mechanics, String imagePath) {
		...
		SequentialGroup verticalGroup = gl.createSequentialGroup().addComponent(tutorialLabel)
				.addComponent(optionalLabel).addComponent(startButton).addComponent(submissionSep)
				.addComponent(question1).addComponent(genderPanel).addComponent(question2).addComponent(agePanel)
				.addComponent(question3).addComponent(gamerPanel).addComponent(submissionSep).addComponent(question4);
	...
	private void replyToGoogleForm() {
		...
		try {
			String response = "entry." + data[1] + "=" + Runner.games.get(Runner.chosenGame) + ",&entry." + data[15]
					+ "=" + Runner.id + ",&entry." + data[12] + "=" + gender.getSelection().getActionCommand()
					+ ",&entry." + data[13] + "=" + age.getSelection().getActionCommand() + ",&entry." + data[14] + "="
					+ gamer.getSelection().getActionCommand() + "," + "&entry." + data[2] + "=" + getMechs(0)
					+ "&entry." + data[3] + "=" + getMechs(1) + "&entry." + data[4] + "=" + getMechs(2) + "&entry."
					+ data[5] + "=" + getChoices() + "&entry." + data[6] + "=" + getResults(0) + "&entry." + data[7]
					+ "=" + getResults(1) + "&entry." + data[8] + "=" + getResults(2) + "&entry." + data[9] + "="
					+ getActions(0) + "&entry." + data[10] + "=" + getActions(1) + "&entry." + data[11] + "="
					+ getActions(2);
	...
	public String getMechs(int level) {
		String actionFile = Runner.games.get(Runner.chosenGame) + "/human/" + level
